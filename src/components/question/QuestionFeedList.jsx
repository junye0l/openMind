...
function QuestionFeedList() {
  return (
    <main className="border-[#C7BBB5] rounded-[16px] w-[716px] mt-[189px] bg-[#F5F1EE] border border-solid flex flex-col justify-center items-center">
      <div className="flex items-center gap-[8px] m-[16px]">
        <Messages className="fill-[#542F1A]" />
        <h2 className="text-[20px] font-[400]">*개의 질문이 있습니다.</h2>
      </div>
      <section className="w-[684px] m-[20px] mt-[0] bg-[#ffffff] rounded-[16px]">
        <div>
          <AnswerNo />
        </div>
        <div>
